...
import com.jga.jumper.util.ViewportUtils;
import com.jga.jumper.util.debug.DebugCameraController;
...
public class GameRenderer implements Disposable {
    ...
    private void init(){
        ...
        coinAnimation =new Animation(0.2f,
                ...
                Animation.PlayMode.LOOP_PINGPONG);
        monsterAnimation =new Animation(0.5f,
...
//        hudStage.setDebugAll(true);
    ...
    private void drawGamePlay(float delta) {
        ...
        TextureRegion obstacleTexture= (TextureRegion) obstacleAnimation.getKeyFrame(controller.getAnimationTime());
        for (Obstacle obstacle:obstacles
            ...
            batch.draw(obstacleTexture,
                 ...
                 0,0,
                    ...
                    1.0f,1.0f,
                    GameConfig.START_ANG-obstacle.getAngleDeg());
        ...
        for (Coin coin:coins
            ...
            batch.draw(coinRegion,
                    ...
                    GameConfig.START_ANG-coin.getAngleDeg());
        ...
        batch.draw(monsterRegion,
               ...
               0,0,
                ...
                1.0f,1.0f,
                GameConfig.START_ANG-monster.getAngleDeg());
    ...
    private void drawDebug(){
        ...
        for (Obstacle obstacle: controller.getObstacles()
            ...
            renderer.rect(
                    ...
                    1,1,
                    GameConfig.START_ANG-obstacle.getSensorAngleDeg()
            );
